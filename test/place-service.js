...
export const placeService = {
  ...
  async makePlace(id, place) {
    const response = await axios.post(`${this.placeUrl}/api/countys/${id}/places`, place);
    return response.data;
  },

  async getPlaces(id) {
    const response = await axios.get(`${this.placeUrl}/api/countys/${id}/places`);
    return response.data;
  },

  async createCounty(newCounty) {
    const response = await axios.post(`${this.placeUrl}/api/countys`, newCounty);
    return response.data;
  },
};
